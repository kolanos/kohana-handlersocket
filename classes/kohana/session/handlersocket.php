...
/**
 * HandlerSocket-based session class.
 *
 * Sample schema:
 *
 ...
 *     ) ENGINE = MYISAM;
 *
 * @package    Kohana/HandlerSocket
 * @category   Session
 * @author     Kohana Team
 * @copyright  (c) 2008-2009 Kohana Team
 * @license    http://kohanaphp.com/license
 */
class Kohana_Session_HandlerSocket extends Session {

	// HandlerSocket instance (read-only)
	protected $_hsread;
	
	// HandlerSocket instance (write-only)
	protected $_hswrte;

	// HandlerSocket table name
	protected $_table = 'sessions';

	// HandlerSocket column names
